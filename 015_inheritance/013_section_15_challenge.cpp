...
/*
  Section 15 Challenge - Inheritance
    ...
    - I have also provided some Account helper functions in Account_Util.h and
      Account_Util.cpp that makes it easy to display, deposit to, and withdraw
      from a vector of Accounts and Savings Accounts
    ...
    - Your challenge is the following:
      ...
      1. Add a Checking account class to the Account hierarchy
        - A Checking account has a name and a balance and has a fee of $1.50 per
          withdrawal transaction
        - Every withdrawal transaction with be assessed this flat fee
      ...
      2. Add a Trust account class to the Account hierarchy
        ...
        - The Trust account withdrawal should only allow 3 withdrawals per
          yearand eahc of these must be less than 20% of the account balance
        - You don't have ot keep track of calendar time for this application,
          just make sure the 4th deposit fails
      
    Hints:
      - reuse existing functionality
      - think about what the Base class will be for the new classes
      - Add helper functions to Account_Util.h and Account_Util.cpp if you wish
      to work with your new classes
      ( You dont have to, but it will make your main much easier to use )

    Have fun!!! You are no longer a beginner c++ programmer!
    - If you want more practice with operator overloading you can overload +=
      and -= for deposit and withdrawal :)
*/