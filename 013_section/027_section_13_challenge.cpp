...
/*
  ...
  - For this challenge you are to develop the foundation for a program for movie
    fanatics to keep track of what movies they have watched and how many times
  ...
  - The program must support the following:
    ...
    - Class Movies 
      - Models a collection of movie objects
    ...
    - Additionally
      * if we try to adda movie whose name is already in the movies collection
    ...
    "I have provided a basic shell as a starting point for one possible solution
    ...
    Don't create a menu-driven system like we've done in the past -- just
    concentrate on getting the program working. Once it is working, you can
    certainly provide a menu system for the user

    This program is not trivial for, but its good challenge for beginning C++
    programmers 

    Here is the sample main and the output. Make sure you understand the program
    flow before you start coding?
*/